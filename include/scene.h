...
class Scene
{
  ...
  public:
  Scene ();
  Scene (pcl::PointCloud<pcl::PointNormal> *cloud_ptr, float d_dist, unsigned int ref_point_downsample_factor = 1);
  ...
  void
  initPPFs (thrust::host_vector<float3> *points, thrust::host_vector<float3> *normals, int n, float d_dist, unsigned int ref_point_downsample_factor = 1);
};
