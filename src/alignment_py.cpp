...
PYBIND11_MODULE (ppf_registration_spatial_hashing, m)
{
  ...
  m.def ("transform_point_cloud", [](const ppf::PointCloud &point_cloud, const Eigen::Affine3f &transform) {
  ...
  m.def ("ppf_registration",
         ...
         py::arg ("scene_cloud"), py::arg ("model_cloud"), py::arg ("model_d_dist"),
         py::arg ("ref_point_downsample_factor"), py::arg ("vote_count_threshold"), py::arg ("cpu_clustering") = false,
         py::arg ("use_l1_norm") = false, py::arg ("use_averaged_clusters") = false, py::arg ("device") = 0,
